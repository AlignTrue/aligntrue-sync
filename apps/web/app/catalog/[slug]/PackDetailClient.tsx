/**
 * Client-side interactive component for pack detail page
...
export function PackDetailClient({ pack, allPacks }: PackDetailClientProps) {
  const [installModalOpen, setInstallModalOpen] = useState(false);

  // Track detail view on mount
  useEffect(() => {
    trackDetailView(pack.slug, pack.version);
