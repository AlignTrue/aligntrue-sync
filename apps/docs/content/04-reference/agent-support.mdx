...
AlignTrue supports **32 AI coding agents** through **50 exporters**. Each exporter generates agent-specific configuration files from your AlignTrue rules, ensuring your AI assistants stay aligned across your entire development workflow.

## Coverage statistics

- **50 exporters** supporting **32 agents**
- **14 MCP configurations** for protocol-based agents
- **24 agent-specific format exporters** for native configurations
