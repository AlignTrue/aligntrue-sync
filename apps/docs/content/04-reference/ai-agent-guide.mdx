...
This is a comprehensive list of AI agents, their supported rule formats and MCP support. If you're looking for AlignTrue's compatibility matrix, see [Agent Support](/docs/04-reference/agent-support).
...
| Amazon Q — `amazonq`                | Rules: `.amazonq/rules/*.md` (desktop & CLI)<br />MCP: `.amazonq/mcp.json` |
...
| OpenAI Codex — `openai-codex`       | Rules: `AGENTS.md` (desktop & CLI)<br />Config: `.codex/config.toml`       |
