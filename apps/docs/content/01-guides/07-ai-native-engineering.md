...
See [Solo developer guide](/docs/01-guides/02-solo-developer-guide) for details.
...
See [Team mode](/docs/03-concepts/team-mode) and [Team guide](/docs/01-guides/04-team-guide) for details.
...
See [Team guide](/docs/01-guides/04-team-guide) for complete workflows.
