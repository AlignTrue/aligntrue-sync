...
> **See it in action:** Check out the [team repo example](https://github.com/AlignTrue/aligntrue-sync/tree/main/examples/team-repo) for team workflows, and [overlays example](https://github.com/AlignTrue/aligntrue-sync/tree/main/examples/overlays-demo) for customization patterns.
...
#   git:https://github.com/AlignTrue/aligntrue-sync/examples/aligns/global.yaml
...
Only add links you trust. Changes to `sources:` in config go through standard git PR review.
