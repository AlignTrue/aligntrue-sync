...
- Paste multiple GitHub URLs (one per line). We validate format locally before fetching.
- Optionally check **Bundle as pack** to create a shareable Align Pack that keeps rules together.
- Title and description are required for packs (280 character limit). Author auto-populates when all URLs share the same GitHub owner.
