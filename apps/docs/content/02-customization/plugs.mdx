...
<Callout type="tip">
  **Real-world scenarios:** Browse [3 complete plugs
  scenarios](../../examples/SCENARIOS.md#plugs-scenarios) including test command
  customization, organization metadata, and stack-specific paths.
</Callout>
