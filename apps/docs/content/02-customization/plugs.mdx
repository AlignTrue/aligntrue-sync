...
- You use packs that contain `[[plug:...]]` template slots
...
**Config fills take precedence over IR fills**, allowing you to override pack defaults without modifying the pack itself.
