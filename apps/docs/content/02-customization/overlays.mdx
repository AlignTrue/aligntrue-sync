...
<Callout type="tip">
  **Real-world scenarios:** Browse [5 complete overlay
  scenarios](../../examples/SCENARIOS.md#overlays-scenarios) including severity
  upgrades, temporary migrations, threshold adjustments, autofix removal, and
  gradual rollouts.
</Callout>
