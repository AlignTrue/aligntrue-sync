...
<Callout type="warning">
  **Experimental feature.** Overlays are functional but under active
  development. APIs may change. Most solo developers can skip this feature
  entirely.
</Callout>
...
> **See it in action:** Check out the [overlays example](https://github.com/AlignTrue/aligntrue-sync/tree/main/examples/overlays-demo) for a working demonstration.
...
> **More examples:** See [SCENARIOS.md](https://github.com/AlignTrue/aligntrue-sync/tree/main/examples/overlays-demo/SCENARIOS.md) in the overlays example for detailed scenarios with expected outputs.
