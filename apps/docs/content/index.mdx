---
title: AlignTrue
description: Instantly sync rules across agents, people, projects and teams. Start in 60 seconds.
---
...
[View full agent compatibility matrix →](/reference/agent-support)
...
- [Catalog](/concepts/catalog) - Browse 11 curated rule packs
...
- [Getting Started](/contributing/getting-started) - Set up your development environment
- [Creating Packs](/contributing/creating-packs) - Author and publish rule packs
- [Adding Exporters](/contributing/adding-exporters) - Add support for new agents

## Development

Setting up AlignTrue for local development:

- [Setup](/development/setup) - Prerequisites and installation
- [Workspace](/development/workspace) - Monorepo structure and packages
- [Commands](/development/commands) - Development commands and scripts
- [Architecture](/development/architecture) - Key architectural concepts

## Learn more

- [GitHub repository](https://github.com/AlignTrue/aligntrue)
- [Catalog website](/catalog) - Browse 11 curated rule packs
