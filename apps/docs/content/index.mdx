...
| ------------------------ | ---------------------------------------------------------------------------------- | --------------------------------------------------------- |
| **Core Sync**            |                                                                                    |                                                           |
| Two-way sync             | Edit IR, markdown, or agent files; AlignTrue keeps them aligned                    | [Sync Behavior](/docs/03-concepts/sync-behavior)          |
...
| 28+ agents               | Comprehensive coverage through 44 exporters                                        | [Agent Support](/docs/04-reference/agent-support)         |
