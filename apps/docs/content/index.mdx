---
title: "Sync rules across AI agents & teams"
...
[View full agent compatibility matrix →](/docs/03-reference/agent-support)
...
- [Team Mode](/docs/02-concepts/team-mode) - Collaboration features for teams
- [Sync Behavior](/docs/02-concepts/sync-behavior) - How two-way sync works
- [Drift Detection](/docs/02-concepts/drift-detection) - Track alignment changes over time
- [Git Workflows](/docs/02-concepts/git-workflows) - Pull and share rules via git
- [Examples](/docs/examples) - Browse 11 curated rule packs

## Reference

- [CLI Commands](/docs/03-reference/cli-reference) - Complete command reference
- [Import Workflow](/docs/03-reference/import-workflow) - Migrate from existing agent configs
- [Troubleshooting](/docs/04-troubleshooting) - Common issues and solutions
...
- [Getting Started](/docs/05-contributing/getting-started) - Set up your development environment
- [Creating Packs](/docs/05-contributing/creating-packs) - Author and publish rule packs
- [Adding Exporters](/docs/05-contributing/adding-exporters) - Add support for new agents

## Development

Setting up AlignTrue for local development:

- [Setup](/docs/07-development/setup) - Prerequisites and installation
- [Workspace](/docs/07-development/workspace) - Monorepo structure and packages
- [Commands](/docs/07-development/commands) - Development commands and scripts
- [Architecture](/docs/07-development/architecture) - Key architectural concepts
