...
→ Auto-detects agents, imports existing rules or scaffolds new ones into `.aligntrue/rules.md`
...
- [Import Workflow](/docs/04-reference/import-workflow) - Migrate from existing agent configs
