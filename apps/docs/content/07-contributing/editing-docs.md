...
- See [getting started](/docs/07-contributing/getting-started) for development setup
- See [workspace structure](/docs/06-development/workspace) for repo layout
- See [architecture](/docs/06-development/architecture) for design principles
