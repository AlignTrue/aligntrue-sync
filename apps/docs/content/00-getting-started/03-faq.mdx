...
<Tabs.Tab>
  ```bash
  yarn global add aligntrue
  ```
</Tabs.Tab>

<Tabs.Tab>
  ```bash
  pnpm add -g aligntrue
  ```
</Tabs.Tab>

<Tabs.Tab>
  ```bash
  bun install -g aligntrue
  ```
</Tabs.Tab>

<Tabs.Tab>
  ```bash
  npx aligntrue init # For one-off commands
  ```
</Tabs.Tab>
...
<Tabs.Tab>
  ```bash
  npx aligntrue --help # For one-off commands
  ```
</Tabs.Tab>
...
[GitHub Discussions](https://github.com/AlignTrue/aligntrue-sync/discussions)
...
- [GitHub Discussions](https://github.com/AlignTrue/aligntrue-sync/discussions) - Ask the community
