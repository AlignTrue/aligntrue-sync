...
**Edit `AGENTS.md`** - This is your primary rules file in natural markdown format.

You can also edit agent-specific files (`.cursor/*.mdc`, etc.) and AlignTrue will sync changes back in solo mode.
