...
<Tabs.Tab>```bash npx aligntrue init # Try without installing ```</Tabs.Tab>
...
Just copy the content into AGENTS.md and run `aligntrue sync`.
...
<Tabs.Tab>```bash npx aligntrue --help # Try without installing ```</Tabs.Tab>
