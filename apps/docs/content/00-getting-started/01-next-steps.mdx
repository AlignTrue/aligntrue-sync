...
The `add link` subcommand automatically adds the source to your `.aligntrue/config.yaml` and fetches updates on each sync. First sync will prompt for privacy consent.
