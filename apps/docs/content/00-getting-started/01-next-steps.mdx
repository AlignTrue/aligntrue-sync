...
**Learn more:** [CLI reference](/docs/04-reference/cli-reference)
...
```bash
aligntrue add link https://github.com/yourorg/rules
```

The `add link` subcommand automatically adds the source to your `.aligntrue/config.yaml`, runs an immediate sync (pass `--no-sync` to skip), and fetches updates on each subsequent sync. First sync will prompt for privacy consent.
...
**Extension guide:** [Adding Exporters](/docs/07-contributing/adding-exporters)
...
cd project-1
aligntrue add link ../shared-rules
aligntrue sync
```
...
- [Git Workflows](/docs/03-concepts/git-workflows) - Pull workflows and source management
...
- [Getting Started](/docs/07-contributing/getting-started) - Contribute to AlignTrue
- [Testing Workflow](/docs/07-contributing/testing-workflow) - Test standards
- [Team Onboarding](/docs/04-reference/cli-reference/onboard) - Internal dev guide
...
- [Issues](https://github.com/AlignTrue/aligntrue-sync/issues)

**Want to contribute?**

- [Contributing Guide](/docs/07-contributing/getting-started)
- [Code of Conduct](https://github.com/AlignTrue/aligntrue-sync/blob/main/CODE_OF_CONDUCT.md)
