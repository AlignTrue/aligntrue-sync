...
**Want to start with external rules?** Use `aligntrue init --source <git-url>` to import from GitHub, GitLab, SSH URLs, or local paths. See [Adding rules](/docs/01-guides/11-adding-rules) for all supported source formats.
