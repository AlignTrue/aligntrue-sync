...
**Want to start with external rules?** Use `aligntrue init --source <url>` to import from a URL or path. See [Adding rules](/docs/01-guides/11-adding-rules) for more options.
