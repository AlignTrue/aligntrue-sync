...
**Want to start with external rules?** Use `aligntrue init <git-url>` to import from GitHub, GitLab, SSH URLs, catalog IDs, or local paths. See [Working with external sources](/docs/01-guides/04-external-sources) for all supported source formats.
...
- [Golden Repository](https://github.com/AlignTrue/aligntrue-sync/tree/main/examples/golden-repo) - Complete working demo
