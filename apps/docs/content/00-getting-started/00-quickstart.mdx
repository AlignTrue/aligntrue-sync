...
The starter template uses a simple markdown format. To author rules in fenced code blocks (literate markdown), see the [Markdown authoring guide](/docs/04-reference/markdown-authoring).
