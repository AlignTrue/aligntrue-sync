...
`;
    ...
    expect(result.sections[2]?.heading).toBe("Debugging");
  });
...
`;
    ...
    expect(result.contentHash).toBe("sha256:xyz789");
  });
...
describe("Team-managed markers", () => {
  it("should detect HTML comment markers", () => {
    const content = `<!-- 🔒 Team-managed section: Changes will be overwritten -->
...
`;
  ...
  it("should detect emoji in heading", () => {
