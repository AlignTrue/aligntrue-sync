...
import { generateLockfile, validateLockfile, formatValidationResult } from '../../src/lockfile/index.js'
...
describe('Lockfile Provenance Tracking', () => {
  ...
  describe('formatValidationResult with provenance', () => {
    it('displays provenance in mismatch error messages', () => {
      ...
      expect(message).toContain('Rule content changed - review before proceeding')
    })
