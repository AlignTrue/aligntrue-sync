...
import { parseCursorMdc, parseCursorMdcFiles, parseAgentsMd } from '@aligntrue/markdown-parser'
 ...
 */
export function getImportSourcePath(agentName: string, workspaceRoot: string = process.cwd()): string {
  switch (agentName.toLowerCase()) {
    case 'cursor':
