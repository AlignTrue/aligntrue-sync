...
`,
  ...
  it("Help speed: completes in <550ms (with quality tooling)", async () => {
    ...
    // Assert average <550ms (increased to account for Windows CI environment variance)
    expect(avgDuration).toBeLessThan(550);
