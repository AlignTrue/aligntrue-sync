...
/**
 * Source repo validation result
 */
export interface SourceRepoValidation {
  valid: boolean;
 ...
 */
export function validateSourceRepoUrl(url: string): SourceRepoValidation {
  if (!url) {
    return {
      valid: false,
 ...
 */
export async function verifySourceRepoExists(
  url: string,
 ...
 */
export function shouldShowSourceLinkedBadge(
