...
- **Safe by default** - Automatic backups before every sync operation
...
| ------------------------ | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **Core Sync**            |                                                                                    |                                                                               |
| Two-way sync             | Edit IR, markdown, or agent files; AlignTrue keeps them aligned                    | [Sync Behavior](https://aligntrue.ai/docs/03-concepts/sync-behavior)          |
...
| Auto-backup              | Safety backups before every sync (configurable)                                    | [Backup & Restore](https://aligntrue.ai/docs/04-reference/backup-restore)     |
...
| Allow lists              | Approve sources for team workflows with `.aligntrue/allow.yaml`                    | [Team Mode](https://aligntrue.ai/docs/03-concepts/team-mode)                  |
...
| Overlays                 | Surgical modifications to packs for safe fork-resistant customization              | [Customization](https://aligntrue.ai/docs/02-customization)                   |
